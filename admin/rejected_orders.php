                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body scroll">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <?php
                                                $query="SELECT a.product_name,a.date,a.status,a.qty,a.price,a.total,l.name as vname,n.trans_id,n.name,n.email,n.address,n.phone,n.delivery_mode,n.upi from order_details a INNER JOIN login l ON l.id = a.vendor_id 
                                                INNER JOIN orders n on n.id=a.order_id WHERE  a.status='Rejected'";

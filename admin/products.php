                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body scroll">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <?php
                                                $query="SELECT p.product_name,p.price,p.code,p.description,p.image, p.deliver_number,l.name from products p INNER JOIN login l on p.user_id = l.id";
                                        ...
                                        <td><?php echo $data['name'] ?></td>                                  
                                            <td> <a href="../user/documents/products/<?php echo $data['image'];?>" class="pop"><img src="../user/documents/products/<?php echo $data['image'];?>" class="rounded" alt="Admin Image" width="70"></a></td>

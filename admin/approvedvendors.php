                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Approved Vendor</h4>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Approved Vendor</h4>
                                    ...
                                    $query="SELECT l.name,v.shop_name,v.vendor_name,l.email,v.vendor_num,l.address,v.adhaar,v.document,v.qrcode,v.status,v.restatus,v.user_id from vendor_register v INNER JOIN login l ON l.id = v.user_id  where  status='Approved'";
                                ...
                                <tr>
                                    ...
                                    <td>
                                                    ...
                                                    if($data['restatus']=="1") 
                                                       {
                                                    ?>
                                <a href="../backend_php/vendorregister.php?action=activate&Dkey=<?php echo $data['user_id'];?>&status=deactive" class='btnbtn redds'>Deactivate</a>
                                <?php } else { ?>
                                    <a href="../backend_php/vendorregister.php?action=activate&Dkey=<?php echo $data['user_id'];?>&status=actives" class='btnbtn greens'>Activate</a>
                                <?php }
                                        ?>
                                                </td>

                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">All Feedbacks</h4>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body scroll">
                                        ...
                                        <tr>
                                            ...
                                            <td><a onClick="javascript: return confirm('Are you Sure Want To Delete');"  href="../backend_php/product_management.php?action=DeleteFeedback&key=<?php echo $data['id'];?>"><i class="fas fa-trash"></i></a></td>                  

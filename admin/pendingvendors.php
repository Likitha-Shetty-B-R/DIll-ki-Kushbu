                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Pending Vendor</h4>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Pending Vendor</h4>
                                    ...
                                    $query="SELECT l.name,v.shop_name,v.vendor_name,l.email,v.vendor_num,l.address,v.adhaar,v.document,v.qrcode,v.status,v.restatus,v.user_id from vendor_register v INNER JOIN login l ON l.id = v.user_id  where status='Pending'";
                                ...
                                <tr>
                                    ...
                                    <td  class="text-center"><a onClick="javascript: return confirm('Are you Sure Want To Approve');"  href="../backend_php/vendorregister.php?action=Approvevendor&key=<?php echo $data['user_id'];?>&status=Approve"><i class="mdi mdi-checkbox-marked-circle-outline" style="font-size: 2rem; color:green"></i></a></td> 
        <td ><a onClick="javascript: return confirm('Are you Sure Want To Reject');"  href="../backend_php/vendorregister.php?action=Approvevendor&key=<?php echo $data['user_id'];?>&status=Reject"><i class="mdi mdi-close-circle-outline" style="font-size: 2rem;  color:red"></i></a></td> 

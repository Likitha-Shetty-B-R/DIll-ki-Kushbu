                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Top Vendor</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Top Vendors</a></li>
                                            <li class="breadcrumb-item active">Top Selling Vendors</li>
                                        </ol>
                                    </div>
                                ...
                                <div class="card">
                                        <div class="card-header d-flex flex-row-reverse ">
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <form action="../backend_php/vendor_payout.php?action=InsertDesigner" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="example-search-input" class="form-label">Flower Name</label>
                                                                    <input type="text" class="form-control"  name="flower_name" autocomplete="off"  required>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="example-search-input" class="form-label">Flower Image</label>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <a href="../user/documents/topdesigner/<?php echo $data['image'];?>" class="pop"><img src="../user/documents/topdesigner/<?php echo $data['image'];?>" class="rounded" alt="Admin Image" width="70"></a></td>    

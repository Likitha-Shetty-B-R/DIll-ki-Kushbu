                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body scroll">
                                        ...
                                        <thead>
                                            ...
                                            <?php
                                                $query="SELECT a.product_name,n.address,a.date,a.status,a.qty,a.price,a.total,a.vendor_id,n.trans_id,n.name,n.email,n.phone,n.delivery_mode,n.upi,n.Delivery_Date,n.Note from orders n INNER JOIN order_details a on n.id=a.order_id WHERE a.vendor_id=$key_code  and a.status='Delivered' or a.status='Accepted'";

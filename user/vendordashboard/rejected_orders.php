                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Rejected Orders</h4>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body scroll">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <?php
                                                $query="SELECT a.id,n.address,a.product_name,a.date,a.status,a.qty,a.price,a.total,a.vendor_id,n.trans_id,n.name,n.email,n.phone,n.delivery_mode,n.upi,n.Delivery_Date,n.Note from orders n INNER JOIN order_details a on n.id=a.order_id WHERE a.vendor_id=$key_code  and a.status='Rejected'";
